...
if __name__ == '__main__':
    assert inceptionv4(num_classes=10, pretrained=False)
    print('success')
    assert inceptionv4(num_classes=1000, pretrained=True)
    print('success')

    # fail
    assert inceptionv4(num_classes=1001, pretrained=True)
    print('fail')
